...
package com.rockdot.plugin.facebook.inject {
	import com.rockdot.plugin.facebook.FacebookPlugin;
	 ...
	 * @inheritDoc
	 */
	public class FBModelInjector implements IObjectPostProcessor {
		private var _applicationContext : IObjectFactory;

		public function FBModelInjector(applicationContext : IObjectFactory) {
