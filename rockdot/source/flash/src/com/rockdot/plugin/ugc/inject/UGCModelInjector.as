...
package com.rockdot.plugin.ugc.inject {
	import com.rockdot.plugin.ugc.UGCPlugin;
	 ...
	 * @inheritDoc
	 */
	public class UGCModelInjector implements IObjectPostProcessor {
		private var _applicationContext : IObjectFactory;

		public function UGCModelInjector(applicationContext : IObjectFactory) {
