package com.rockdot.library.view.component.book.containers {
	import com.rockdot.library.view.component.book.IndexChangedEvent;
	 ...
	 * 
	 */
	public class SuperViewStack extends RockdotSpriteComponent {
...
//			child.removeEventListener(FlexEvent.CREATION_COMPLETE, this.childCreationComplete);
	...
	// CUSTOM:
		 ...
		 * @private
		 */
		protected function drawFade (child:Sprite):void {
		 ...
		 * @private
		 */
		protected function resizeFade (child:Sprite):void {
			
			// point out the Shape:
			var shape:Shape = child.getChildByName(SuperViewStack.FADESHAPE_NAME) as Shape;
	...
	// ACCESSORS:
		 ...
		 */
		public function get selectedChild ():Sprite {
			return super.getChildAt(this._selectedIndex) as Sprite;
		}
		public function set selectedChild (child:Sprite):void {
