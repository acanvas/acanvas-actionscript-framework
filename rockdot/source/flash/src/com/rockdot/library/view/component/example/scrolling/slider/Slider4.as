package com.rockdot.library.view.component.example.scrolling.slider {
	 ...
	 */
	public class Slider4 extends Slider {
		public function Slider4(orientation : String, min : Number, max : Number, size : Number, continuous : Boolean = false) {
			super(orientation, min, max, size - 44, continuous);
