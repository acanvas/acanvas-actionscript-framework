...
package com.rockdot.core.context {
	 ...
	 * @version 1.0
	 */
	public class RockdotKeyValuePropertiesParser implements IPropertiesParser {
		...
		private static const logger:ILogger = getClassLogger(RockdotKeyValuePropertiesParser);

		/**
		 * Constructs a new <code>PropertiesParser</code> instance.
		 */
		public function RockdotKeyValuePropertiesParser() {
			super();
		}
