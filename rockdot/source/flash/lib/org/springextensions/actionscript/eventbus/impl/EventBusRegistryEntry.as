...
package org.springextensions.actionscript.eventbus.impl {
	...
	public class EventBusRegistryEntry {
		...
		/**
		 * Creates a new <code>EventBusRegistryEntry</code> instance.
		 * @param proxy
		 * @param types
		 * @param topics
		 */
		public function EventBusRegistryEntry(inst:Object, types:Vector.<EventTypeEntry>=null, classes:Vector.<ClassEntry>=null) {
			super();
			_instance = inst;
