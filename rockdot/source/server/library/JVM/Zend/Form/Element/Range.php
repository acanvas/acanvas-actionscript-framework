...
+---------------------------------------------------------------------------------------+ 
 *
 * @desc JVM_Zend_Form_Element_Range extends Zend_Form_Element_Text
 * handles html5 form-element "range"
 * <input type="range" ...
 * 
...
class JVM_Zend_Form_Element_Range extends Zend_Form_Element_Text{
/*	+-----------------------------------------------------------------------------------+
	| 	contruct and init functionallity
	+-----------------------------------------------------------------------------------+  */
   /**
    * @desc 
    * initialize Zend_Form_Element_Text with the type "range"
