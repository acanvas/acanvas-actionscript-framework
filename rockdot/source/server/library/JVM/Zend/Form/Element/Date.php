...
+---------------------------------------------------------------------------------------+ 
 *
 * @desc JVM_Zend_Form_Element_Date extends Zend_Form_Element_Text
 * handles html5 form-element "date"
 * <input type="date" ...
 * 
...
class JVM_Zend_Form_Element_Date extends Zend_Form_Element_Text{
/*	+-----------------------------------------------------------------------------------+
	| 	contruct and init functionallity
	+-----------------------------------------------------------------------------------+  */
   /**
    * @desc 
    * initialize Zend_Form_Element_Text with the type "date"
