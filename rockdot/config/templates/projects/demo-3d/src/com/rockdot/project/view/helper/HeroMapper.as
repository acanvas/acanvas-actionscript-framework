package com.rockdot.project.view.helper {
	...
	public class HeroMapper extends Sprite
	{
		[Embed(source="/../resources/away3d/pb/Sharpen.pbj", mimeType="application/octet-stream")]
		private var BumpClass:Class;
		[Embed(source="/../resources/away3d/pb/NormalMap.pbj", mimeType="application/octet-stream")]
		private var NormalClass:Class;
		[Embed(source="/../resources/away3d/pb/Outline.pbj", mimeType="application/octet-stream")]
		...
		public function HeroMapper(origineMap:BitmapData = null)
		{
			_shaders = new Vector.<Shader>();
			_bitmap = new Vector.<Bitmap>();
			_bitdata = new Vector.<BitmapData>();
			
			_bitmap.push(new Bitmap(origineMap));
			_bitmap.push(new Bitmap(origineMap));
			_bitmap.push(new Bitmap(origineMap));
			
			_shaders.push( new Shader(new BumpClass()) );
			_shaders.push( new Shader(new NormalClass()) );
			_shaders.push( new Shader(new LumaClass()) );
