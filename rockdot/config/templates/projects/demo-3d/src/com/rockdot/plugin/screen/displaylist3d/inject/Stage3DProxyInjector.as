 ...
 */
package com.rockdot.plugin.screen.displaylist3d.inject {
	 ...
	 * @inheritDoc
	 */
	public class Stage3DProxyInjector implements IObjectPostProcessor {
		private var _applicationContext : IObjectFactory;

		public function Stage3DProxyInjector(applicationContext : IObjectFactory) {
		...
		public function postProcessAfterInitialization(object : *, objectName : String) : * {
			...
			if (object is IRockdotManagedSpriteComponent3D) {
				var uiService : IScreen3DService = _applicationContext.getObject(ScreenPluginBase.SERVICE_UI);
				(object as IRockdotManagedSpriteComponent3D).stageProxy = uiService.stage3DProxy;
			}
