package com.rockdot.project.view.screen {
	...
	import com.rockdot.project.view.data.ListSettings;
	...
	public class ListScreen extends Screen implements IScreen
	{
		...
		{
			new RockdotEvent(StateEvents.ADDRESS_SET, "/list/settings").dispatch();
		}
