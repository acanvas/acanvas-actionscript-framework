package com.rockdot.project.view.screen {
	...
	import com.rockdot.project.view.data.SliderSettings;
	...
	public class SliderScreen extends Screen implements IScreen
	{
		...
		{
			new RockdotEvent(StateEvents.ADDRESS_SET, "/slider/settings").dispatch();
		}
	}
}