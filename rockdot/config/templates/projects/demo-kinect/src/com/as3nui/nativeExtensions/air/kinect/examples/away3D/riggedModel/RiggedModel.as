package com.as3nui.nativeExtensions.air.kinect.examples.away3D.riggedModel
{
	...
	public class RiggedModel extends ObjectContainer3D
	{
		...
		[Embed(source="/../resources/character/character.jpg")]
		private var BodyMaterial:Class;
		[Embed(source="/../resources/character/character.md5mesh",mimeType = "application/octet-stream")]
		private var BodyMesh:Class;
		...
		public function RiggedModel(user:User)
		{
			...
			AssetLibrary.loadData(BodyMesh,null,null,new RotatedMD5MeshParser());
//			AssetLibrary.load(new URLRequest("/../resources/assets/characters/export/character.md5mesh"));
		}
