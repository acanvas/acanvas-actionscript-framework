package com.tonybeltramelli.airkinect.userAction.gesture {
	...
	public class DepthSwipe extends AGesture {
		...
		override protected function _gestureDetected(direction : Number) : void {
			direction > 0 ? _dispatcher.dispatch(new KinectGestureEvent(KinectGestureEvent.FORWARD_SWIPE)) : _dispatcher.dispatch(new KinectGestureEvent(KinectGestureEvent.BACKWARD_SWIPE));
		}
	}
}
