package com.rockdot.project.view.screen {
	 ...
	 */
	public class Home extends RockdotManagedSpriteComponent{
		...
		override public function init(data : * = null) : void {
			...
			_button = new SimpleButton(getProperty("button.facebook"), _width, BootstrapConstants.HEIGHT_RASTER);
			_button.submitEvent = new RockdotEvent(ProjectExtendedEvents.APP_LOGIN_DISPATCH, {prompt:"facebook.albums", next:getProperty("screen.import.facebook.album.url", true)});
			addChild(_button);
