package com.rockdot.project.view.screen {
	...
	import com.rockdot.project.view.element.FBAlbumListCell;
...
//			_button.y = _height - _button.height - Constants.SPACER;
		...
		private function _onFBPhotosReceived(data:*=null) : void {
			new RockdotEvent(StateEvents.ADDRESS_SET, getProperty("screen.import.facebook.photo.url", true)).dispatch();
