...
package com.rockdot.project.inject {
	import com.rockdot.project.Project;
	 ...
	 * @inheritDoc
	 */
	public class ModelInjector implements IObjectPostProcessor {
		private var _applicationContext : IObjectFactory;

		public function ModelInjector(applicationContext : IObjectFactory) {
